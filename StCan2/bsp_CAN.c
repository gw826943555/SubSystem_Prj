...
void CAN_InterruptConfig(void)
{
	...
	CAN_InitStructure.CAN_SJW=CAN_SJW_1tq;			//Resynchronization jump with
...
//CAN_InitStructure.CAN_Prescaler=6;			  
  ...
  CAN_InitStructure.CAN_Prescaler =600;
   ...
   #error "Please select first the CAN Baudrate in Private defines in main.c "
	...
	CAN_FilterInitStructure.CAN_FilterNumber=0;											//set the filter that will be actived 	 
	...
	CAN_FilterInitStructure.CAN_FilterIdHigh=(((u32)CAN_RX_ID<<21)&0xFFFF0000)>>16;               
	CAN_FilterInitStructure.CAN_FilterIdLow=(((u32)CAN_RX_ID<<21)|CAN_ID_STD|CAN_RTR_DATA)&0xFFFF;
